  ...
  var script = {
    ...
    methods: {
      ...
      setupCustomImageGalleryHandler: function setupCustomImageGalleryHandler() {
        ...
        elem.addEventListener("click", this.customImageGalleryHandler, true); // console.log("sdfsd", elem);
